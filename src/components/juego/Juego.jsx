...
useEffect(() => {
    ...
    if(ptos_usuario>ptos_computadora){
        resultado=usuario;
		setImagen_ganador("../../../deploy/usuario.png");
    }else{
        if(ptos_usuario<ptos_computadora){
            resultado="compu";
			setImagen_ganador("../../../deploy/supercompu.png");
        }else{
            resultado="empate";
			setImagen_ganador("../../../deploy/empate.png");
		}
    }
	...
	return (
		<>
			...
			<br /><br />
			<h4 className="instrucciones">Mirá, este será tu rival, nuestro equipo de 6 Avengers:</h4>
			...
			<form onSubmit={submitHandler}>
				...
				<h4 className="instrucciones">Ahora tenés que formar tu equipo, comenzá elegiendo tus 2 Avengers favoritos:</h4>
				<div className="flexBox_TJs">
				...
				<br /><br />
				<h4 className="instrucciones">Muy bien, 3 Avengers más serán seleccionados al azar para tu equipo y el 6to. serás vos. Elegí los dos atributos que más te gusten, serán los poderes que más te representen y los de máximo puntaje en tu tarjeta Advenger.</h4>
				...
				<br />
				<button className="continuar" type="submit"><h4>Click para continuar</h4></button>
				...
				<h4 className="instrucciones">Cada Avenger tiene una tarjeta de poderes, con ellas se hizo una tarjeta única y representativa por equipo promediando, en cada uno de los poderes, los valores que tienen sus integrantes.</h4>
				...
				<h3 className="instrucciones">EQUIPO COMPU</h3>
				</div>
				<div className="tarjeta_equipos_imagen">
				<p><img className="solo_imagen_compu" src="../../../deploy/supercompu.png" alt="Compu"></img></p>
				</div>
				</div>
				</div>
				
				<div className="versus">
				<p><img src="../../../deploy/versus.png" alt="vs." width="90"></img></p>
				</div>
				...
				<div className="tarjeta_equipos_nombre_imagen">	
				<div className="tarjeta_equipos_nombre">
				<h3 className="instrucciones">TU EQUIPO</h3>
				</div>
				<div className="tarjeta_equipos_imagen">
				<p><img src="../../../deploy/usuario.png" alt="Usuario"></img></p>
				</div>
				</div>
				</div>
				</div>
				<br /><br />
				<h2 className="instrucciones">"Pasá el cursor por abajo para descubrir al ganador!</h2>
				...
				<div className="imagen_ganador">
					...
					/>
					<br /><br /><br />
					<h2 className="instrucciones">GAME OVER</h2>
				</div>
			</form>
			<h3 className="invitacion">¡ Start y volvés a jugar !</h3>
			<h2 className="invitacion">↓</h2>
			<div className="start">
				<a href="juego" className="link">
					<p className="start"><button><img src="../../../deploy/start.png" alt="Botón Start Game" width="125"></img></button></p>
				</a>
			</div>
