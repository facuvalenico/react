...
export const OtroJuego = () => {
    ...
    tarjeta_avenger1.forEach((element,i)=>{
        if(tarjeta_avenger2[i]>tarjeta_avenger1[i]){
            ...
            if(tarjeta_avenger2[i]<tarjeta_avenger1[i]){
                ...
                ptos_avenger2=ptos_avenger2;
                ptos_avenger1=ptos_avenger1;
            }   
        }
    });
    ...
    <>
       ...
       <div className="jugarNuevamente">
            	<a href="otrojuego" className="link">
					<button className="start"><u>Volver a jugar</u></button>
				</a>
			</div>  
            <form onSubmit={submitHandler}>
                ...
                <h1 className="ganadorJuego2">{ganador}</h1>
                <p className="heroesIndexJuego2">
				   <img className="capitan" src="../../../deploy/capitan.png" alt="Capitán América"></img>
				   <input type="image" className="startJuego2" src="../../../deploy/start.png" alt="Botón Start Game"></input>
				   <img className="loki" src="../../../deploy/loki.png" alt="Loki"></img>
				</p>             
            </form>
